      ...
      <body className="bg-white dark:bg-zinc-900 transition-colors duration-500">
        <div className={containerStyles}>
          ...
          <div className="md:w-1/2">
            ...
            Health insurance policies typically cover a wide range of medical services and expenses, including hospitalization, doctor's visits, diagnostic tests, prescription medications, surgical procedures, and preventive care such as vaccinations and health screenings. The extent of coverage varies depending on the type of health insurance plan and the specific terms and conditions of the policy.
            </p>
