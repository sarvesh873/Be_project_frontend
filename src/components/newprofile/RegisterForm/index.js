  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const apiUrl = "https://web-production-98b9a.up.railway.app/api/profile/";
  ...
  const submitFormData = () => {
    ...
    if (username == jusername) {
      const data = {
        ...
        hasLoan: hasLoan,
        laondura: parseInt(laondura), // You may need to get this from somewhere
        loanAmount: parseInt(loanAmount), // You may need to get this from somewhere
        hasInsurance:hasInsurance,
        insuranceAmount : parseInt(insuranceAmount),
        children: formatdepDataForAPI(),
        family: formatchildDataForAPI(),
        monthlyExpenditure: parseInt(monthlyExpenditure)
      };
